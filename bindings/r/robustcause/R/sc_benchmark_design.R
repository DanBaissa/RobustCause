make_sc_benchmark_design <- function(contamination = c("none", "treated_pre_spike", "donor_pre_spike", "treated_and_donor_pre_spike", "heavy_tails", "donor_pool_mismatch", "predictor_spike", "mixed_outcome_predictor"),
                                     n_donors = c(10L, 25L),
                                     n_pre = c(15L, 30L, 60L),
                                     n_post = 10L,
                                     n_factors = 2L,
  ...
  design <- design[keep_none | keep_mismatch | keep_outcome | keep_predictor | keep_mixed, , drop = FALSE]
