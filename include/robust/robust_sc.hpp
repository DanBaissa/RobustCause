...
// Robust synthetic control via an MM-style workflow on the donor simplex.
// This reduces sensitivity to contaminated pre-treatment periods, but it does
// not resolve donor-pool mismatch or lack of overlap.
struct MmscControl {
